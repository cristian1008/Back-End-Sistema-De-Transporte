...
import {listarVehiculos, registrarVehiculo, actualizarVehiculo, eliminarVehiculo, obtenerVehiculo, listarVehiculosConductor, quitarConductorVehiculo, listarVehiculosConductorDistinto, adicionConductorVehiculo} from "../controles/controlVehiculos";
...
RutasVehiculos.patch("/quitarConductorVehiculo", quitarConductorVehiculo);

//asociar conductor al vehiculo
RutasVehiculos.get("/listarVehiculosConductorDistinto/:id", listarVehiculosConductorDistinto);

RutasVehiculos.patch("/adicionConductorVehiculo/:id", adicionConductorVehiculo);
